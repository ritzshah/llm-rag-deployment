...
'''
# Parameters
curl -X 'POST' 'https://granite-8b-code-instruct-maas-apicast-production.apps.llmaas.llmaas.redhatworkshops.io:443/v1/completions' -H 'accept: application/json' -H 'Content-Type: application/json' -H 'Authorization: Bearer CHANGEME' \
-d '{
...
DB_CONNECTION_STRING = 'postgresql+psycopg://vectordb:vectordb@postgresql-service.ic-shared-rag-llm.svc.cluster.local:5432/vectordb'
DB_COLLECTION_NAME = 'documents_test'

# Streaming implementationcd 
